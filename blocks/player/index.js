...
/* harmony export */ });
var icons = {};
var fill = 'rgb(14.117647%,22.352941%,48.627451%)';
icons.edisound = wp.element.createElement("svg", {
...
/* harmony import */ var _icons_icons_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/**
...
var _wp$editor = wp.editor,
    InputControl = _wp$editor.InputControl,
...
registerBlockType('edisound/player', {
  ...
  category: 'embed',
  icon: _icons_icons_js__WEBPACK_IMPORTED_MODULE_0__["default"].edisound,
  supports: {
    html: false
  },
  edit: function edit(props) {
    var _wp$data = wp.data,
        ...
        subscribe = _wp$data.subscribe; // La fonction qui met à jour la valeur
    ...
    var onBlockLoad = function onBlockLoad(content) {
      loadPlayerEdisound(true);
    };

    return wp.element.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, wp.element.createElement(BlockControls, null, wp.element.createElement(AlignmentToolbar, {
    ...
    wp.element.createElement("div", {
      ...
      className: "rwm-podcast-player",
      "data-pid": props.attributes.content.trim()
    }, __('Loading...')), wp.element.createElement("img", {
      height: "0",
      width: "0",
      onLoad: onBlockLoad,
